    ...
    <nav className="border-gray-200 sticky backdrop-blur-xl z-50 top-0 w-full flex lg:px-0 px-5 py-0.5 bg-gradient-to-r from-white-900 via-white-600 to-white-400 ...">
      <div className="max-w-full lg:w-4/5 relative w-full flex flex-wrap items-center justify-between mx-auto">
        ...
        <motion.div
          ...
          id="navbar-solid-bg"
        >
          <ul className="flex flex-col md:flex-row font-medium lg:mx-0 mr-5 lg:my-2 mt-1 rounded-lg md:space-x-8 justify-center items-center rtl:space-x-reverse">
            <li className="mb-2 md:mb-0">
              <a href="#policy">
                <button className="bg-gray-400 hover:bg-gray-700 text-white font-bold py-2 px-4 border border-black-500 rounded">
                  Get Started
                </button>
              </a>
            </li>
            <li className="mb-2 md:mb-0">
              <a
                href="#blogs"
                className="block py-2 px-3 text-gray-900 dark:text-black lg:text-lg text-sm font-medium"
              >
                Blogs
              </a>
            </li>
